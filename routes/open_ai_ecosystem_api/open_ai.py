...
@open_ai_bp.route('/run/v1/<user_name>/chat/completions', methods=['POST'])
def run_model(user_name):
    ...
    b_service_url = base64.b64decode(Constants.OPEN_AI_HOST_URL).decode('utf-8').format(user_name)
